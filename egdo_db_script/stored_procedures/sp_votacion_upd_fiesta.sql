...
BEGIN 
	...
	INSERT INTO VOTOS(id_usuario_voto,disenio_votado,tipo_disenio,instancia_voto,activdad_disenio_num) VALUES(6,5,1,1,@actividad_disenio); 
-- INSERT INTO VOTOS(id_usuario_voto,disenio_votado,tipo_disenio,instancia_voto,activdad_disenio_num) VALUES(6,11,1,1,@actividad_disenio);/*---BORRAR PARA VOTARLO EN LA DEMO*/	
	INSERT INTO VOTOS(id_usuario_voto,disenio_votado,tipo_disenio,instancia_voto,activdad_disenio_num) VALUES(6,8,1,1,@actividad_disenio);	
	INSERT INTO VOTOS(id_usuario_voto,disenio_votado,tipo_disenio,instancia_voto,activdad_disenio_num) VALUES(7,5,1,1,@actividad_disenio);	
	INSERT INTO VOTOS(id_usuario_voto,disenio_votado,tipo_disenio,instancia_voto,activdad_disenio_num) VALUES(7,8,1,1,@actividad_disenio);
-- INSERT INTO VOTOS(id_usuario_voto,disenio_votado,tipo_disenio,instancia_voto,activdad_disenio_num) VALUES(7,3,1,1,@actividad_disenio);/*---BORRAR PARA VOTARLO EN LA DEMO*/
	INSERT INTO VOTOS(id_usuario_voto,disenio_votado,tipo_disenio,instancia_voto,activdad_disenio_num) VALUES(7,3,1,1,@actividad_disenio);
	INSERT INTO VOTOS(id_usuario_voto,disenio_votado,tipo_disenio,instancia_voto,activdad_disenio_num) VALUES(8,5,1,1,@actividad_disenio);
	INSERT INTO VOTOS(id_usuario_voto,disenio_votado,tipo_disenio,instancia_voto,activdad_disenio_num) VALUES(8,8,1,1,@actividad_disenio);
	INSERT INTO VOTOS(id_usuario_voto,disenio_votado,tipo_disenio,instancia_voto,activdad_disenio_num) VALUES(9,3,1,1,@actividad_disenio);
	INSERT INTO VOTOS(id_usuario_voto,disenio_votado,tipo_disenio,instancia_voto,activdad_disenio_num) VALUES(10,8,1,1,@actividad_disenio);
	INSERT INTO VOTOS(id_usuario_voto,disenio_votado,tipo_disenio,instancia_voto,activdad_disenio_num) VALUES(10,5,1,1,@actividad_disenio);
	
	/*VOTOS DE LAS REMERAS*/ 																/*1->4, 6->6, 9->3, 12->0*/ 
	INSERT INTO VOTOS(id_usuario_voto,disenio_votado,tipo_disenio,instancia_voto,activdad_disenio_num) VALUES(6,6,2,1,@actividad_disenio);
-- INSERT INTO VOTOS(id_usuario_voto,disenio_votado,tipo_disenio,instancia_voto,activdad_disenio_num) VALUES(6,14,2,1,@actividad_disenio);/*BORRAR PARA VOTAR EN LA DEMO*/
	INSERT INTO VOTOS(id_usuario_voto,disenio_votado,tipo_disenio,instancia_voto,activdad_disenio_num) VALUES(6,1,2,1,@actividad_disenio);
	INSERT INTO VOTOS(id_usuario_voto,disenio_votado,tipo_disenio,instancia_voto,activdad_disenio_num) VALUES(7,6,2,1,@actividad_disenio);
	INSERT INTO VOTOS(id_usuario_voto,disenio_votado,tipo_disenio,instancia_voto,activdad_disenio_num) VALUES(7,1,2,1,@actividad_disenio);
-- INSERT INTO VOTOS(id_usuario_voto,disenio_votado,tipo_disenio,instancia_voto,activdad_disenio_num) VALUES(7,16,2,1,@actividad_disenio);/*BORRAR PARA VOTAR EN LA DEMO*/
	INSERT INTO VOTOS(id_usuario_voto,disenio_votado,tipo_disenio,instancia_voto,activdad_disenio_num) VALUES(7,9,2,1,@actividad_disenio);
	INSERT INTO VOTOS(id_usuario_voto,disenio_votado,tipo_disenio,instancia_voto,activdad_disenio_num) VALUES(8,6,2,1,@actividad_disenio);
	INSERT INTO VOTOS(id_usuario_voto,disenio_votado,tipo_disenio,instancia_voto,activdad_disenio_num) VALUES(8,1,2,1,@actividad_disenio);
	INSERT INTO VOTOS(id_usuario_voto,disenio_votado,tipo_disenio,instancia_voto,activdad_disenio_num) VALUES(9,6,2,1,@actividad_disenio);
	INSERT INTO VOTOS(id_usuario_voto,disenio_votado,tipo_disenio,instancia_voto,activdad_disenio_num) VALUES(10,6,2,1,@actividad_disenio);
	INSERT INTO VOTOS(id_usuario_voto,disenio_votado,tipo_disenio,instancia_voto,activdad_disenio_num) VALUES(10,1,2,1,@actividad_disenio);
