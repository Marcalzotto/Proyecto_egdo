...
$grid["sortname"] = 'id_usuario'; // by default sort grid by this field
$grid["sortorder"] = "asc"; // ASC or DESC
$grid["caption"] = "Control Alumnos"; // caption of grid
...
$g->select_command = "SELECT u.id_usuario, nombre, apellido,
							email,fechaAltaUsuario, contrasenia, u.id_rol, 
							r.descripcion_rol, u.id_curso, c.nombre_escuela ,id_confirmacion,estadoActivacion
...
$col["name"] = "id_usuario"; // grid column name, must be exactly same as returned column-name from sql (tablefield or field-alias) 
$col["width"] = "11";
...
$col = array();
$col["title"] = "Contrasenia"; // caption of column
$col["name"] = "contrasenia"; // grid column name, must be exactly same as returned column-name from sql (tablefield or field-alias) 
$col["width"] = "15";
$col["sortable"] = false; // this column is not sortable
...
$col = array();
$col["title"] = "IdRol"; // caption of column
$col["name"] = "id_rol"; // grid column name, must be exactly same as returned column-name from sql (tablefield or field-alias) 
$col["width"] = "8";
$col["sortable"] = false; // this column is not sortable
$col["search"] = false; // this column is not searchable
$col["editable"] = true;
...
$col = array();
$col["title"] = "RolDescripcion"; // caption of column
$col["name"] = "descripcion_rol"; // grid column name, must be exactly same as returned column-name from sql (tablefield or field-alias) 
$col["width"] = "15";
$col["sortable"] = false; // this column is not sortable
$col["search"] = false; // this column is not searchable
$col["editable"] = false;
...
$col = array();
$col["title"] = "IdCurso"; // caption of column
$col["name"] = "id_curso"; // grid column name, must be exactly same as returned column-name from sql (tablefield or field-alias) 
$col["width"] = "8";
$col["sortable"] = false; // this column is not sortable
$col["search"] = false; // this column is not searchable
$col["editable"] = true;
...
$col = array();
$col["title"] = "Escuela"; // caption of column
$col["name"] = "nombre_escuela"; // grid column name, must be exactly same as returned column-name from sql (tablefield or field-alias) 
$col["width"] = "10";
$col["sortable"] = false; // this column is not sortable
$col["search"] = false; // this column is not searchable
$col["editable"] = false;
...
$col = array();
$col["title"] = "Confirmacion"; // caption of column
$col["name"] = "id_confirmacion"; // grid column name, must be exactly same as returned column-name from sql (tablefield or field-alias) 
$col["width"] = "10";
$col["sortable"] = false; // this column is not sortable
$col["search"] = false; // this column is not searchable
$col["editable"] = true;
...
$col = array();
$col["title"] = "Activacion"; // caption of column
$col["name"] = "estadoActivacion"; // grid column name, must be exactly same as returned column-name from sql (tablefield or field-alias) 
$col["width"] = "10";
$col["sortable"] = false; // this column is not sortable
$col["search"] = false; // this column is not searchable
$col["editable"] = true;
...
<html>
	...
	<h3 class="title"><i class="fa fa-user" aria-hidden="true"></i>&nbsp; Alumnos</h3>
