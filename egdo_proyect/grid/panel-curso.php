...
$grid["sortname"] = 'id_curso'; // by default sort grid by this field
$grid["sortorder"] = "asc"; // ASC or DESC
$grid["caption"] = "Control Cursos"; // caption of grid
...
$g->select_command = "SELECT id_curso, nombre_escuela , localidad,
							curso_anio, curso_letra, cant_alumnos, fecha_creacion
							FROM curso c";
...
$col = array();
$col["title"] = "Curso"; // caption of column
$col["name"] = "curso_anio"; // grid column name, must be exactly same as returned column-name from sql (tablefield or field-alias) 
$col["width"] = "8";
$col["sortable"] = false; // this column is not sortable
$col["search"] = false; // this column is not searchable
$col["editable"] = true;
...
$col = array();
$col["title"] = "Division"; // caption of column
$col["name"] = "curso_letra"; // grid column name, must be exactly same as returned column-name from sql (tablefield or field-alias) 
$col["width"] = "15";
$col["sortable"] = false; // this column is not sortable
$col["search"] = false; // this column is not searchable
$col["editable"] = true;
...
$col = array();
$col["title"] = "CantAlumnos"; // caption of column
$col["name"] = "cant_alumnos"; // grid column name, must be exactly same as returned column-name from sql (tablefield or field-alias) 
$col["width"] = "15";
$col["sortable"] = false; // this column is not sortable
$col["search"] = false; // this column is not searchable
$col["editable"] = true;
...
<html>
	...
	<h3 class="title"><i class="fa fa-university" aria-hidden="true"></i>&nbsp; Cursos</h3>
