...
<html>
	<head>
		...
		<script type="text/javascript" src="assets/js/functionEditComUPD.js"></script>
								...
								<section class="12u 12u">
									...
									<?php
										...
										if(filter_var($id_comentario, FILTER_VALIDATE_INT) === false){  
											...
											//if($_GET['idempresa']>0){
											$consulta = ("SELECT upd.id_comentario,upd.comentario,upd.fecha_hora,
															u.id_usuario,u.nombre,u.apellido
															FROM comentario_upd AS upd JOIN usuario AS u ON upd.id_usuario = u.id_usuario
															WHERE upd.id_comentario='$id_comentario'");
