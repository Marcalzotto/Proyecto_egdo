...
<html>
	<head>
		...
		<script type="text/javascript" src="assets/js/functionAddCurso.js"></script>
						...
						<section id="intro" class="container">
							...
							<div class="row"> <!-- Row Principal -->
								<section class="12u 12u">
									...
									<!-- form start -->
									<form role="form" id="add-curso" autocomplete="off" method="post" action="">
									<!--<div class="grid-demo">-->
									<div class="row uniform 50%">	
										<!-- Break -->
										<div class="-1u 2u"><span>Nombre Escuela</span></div>
										<div class="-1u 5u$"><span><input type='text' name='esc_name' class="form-class" placeholder='Nombre Curso'/></span>
										</div>
										<!-- Break -->
										<div class="-1u 2u"><span>Localidad</span></div>
										<div class="-1u 5u$"><span><input type='text' name='esc_loc' class="form-class" placeholder='Localidad'/></span></div>
										<!-- Break -->
										<div class="-1u 2u"><span>Curso</span></div>
										<div class="-1u 5u$"><span><input type='text' name='esc_curso' class="form-class" placeholder='Curso'/></span></div>
										<!-- Break -->
										<div class="-1u 2u"><span>Divisi&oacute;n </span></div>
										<div class="-1u 5u$"><span><input type='text' name='esc_div' class="form-class" placeholder='Division'/></span></div>
										<!-- Break -->
										<div class="-1u 2u"><span>Cantidad Alumnos</span></div>
										<div class="-1u 5u$"><span><input type='text' name='esc_cant' class="form-class" placeholder='Cantidad Alumnos'/></span></div>
										<!-- Break -->
										<div class="-2u 8u$">
