...
<html>
	<head>
		...
		<script type="text/javascript" src="assets/js/functionEditComInfo.js"></script>
							...
							<div class="row"> <!-- Row Principal -->
								<section class="12u 12u">
									...
									<div class="row uniform">
										<div class="12u">
											<a href="moderar-comentarioInfoViaje.php" class="button button-big ver"><i class="fa fa-eye fa-fw" aria-hidden="true"></i>&nbsp;Ver Comentarios Info Viaje</a>
											<hr class="major"/>
										</div>
									...
									<?php
										...
										if(filter_var($id_comentario, FILTER_VALIDATE_INT) === false){  
											...
											//if($_GET['idempresa']>0){
											$consulta = ("SELECT iv.id_comment,iv.comentario,iv.id_info_viaje,iv.fecha,
															u.id_usuario,u.nombre,u.apellido
															FROM comentario_infoviaje AS iv JOIN usuario AS u ON iv.id_usuario = u.id_usuario
															WHERE iv.id_comment='$id_comentario'");
									...
									<div class="row uniform 50%">	
										<!-- Break -->
										<input type='hidden' name='comentario' value='<?php echo $id_protegido=base64_encode($row['id_comment']); ?>'/>
										<!-- Break -->
										...
										<div class="-1u 5u$"><span><?php echo $row['fecha']; ?></span></div>
										<!-- Break -->
