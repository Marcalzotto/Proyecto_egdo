...
<html>
	<head>
		...
		<script type="text/javascript" src="assets/js/functionEditAlumno.js"></script>
							...
							<div class="row"> <!-- Row Principal -->
								<section class="12u 12u">
									...
									<?php
										...
										$id_usuario=base64_decode($_GET['usu']);
									...
									<!-- form start -->
									<form role="form" id="edit-user" autocomplete="off" method="post" action="">
									<!--<div class="grid-demo">-->
									<div class="row uniform 50%">	
										<!-- Break -->
										<input type='hidden' name='usu' value='<?php echo $id_protegido=base64_encode($row['id_usuario']); ?>'/>
										<!-- Break -->
										<div class="-1u 2u"><span>Nombre</span></div>
										<div class="-1u 5u$"><span><input type='text' name='user_name' class="form-class" placeholder='Nombre Alumno' value='<?php echo $row['nombre']; ?>'/></span>
										</div>
										<!-- Break -->
										<div class="-1u 2u"><span>Apellido</span></div>
										<div class="-1u 5u$"><span><input type='text' name='user_apellido' class="form-class" placeholder='Apellido Alumno' value='<?php echo $row['apellido']; ?>'/></span></div>
										<!-- Break -->
										<div class="-1u 2u"><span>Email</span></div>
										<div class="-1u 5u$"><span><input type='text' name='user_email' class="form-class" placeholder='Apellido Alumno' value='<?php echo $row['email']; ?>'/></span></div>
										<!-- Break -->
										...
										<div class="-1u 5u$"><span><input type='text' name='user_estado' class="form-class" placeholder='Nombre Alumno' value='<?php echo $row['estadoActivacion']; ?>'/></span>
										</div>
										<!-- Break -->
										<div class="-2u 8u$">
