...
<html>
	<head>
		...
		<script type="text/javascript" src="assets/js/functionPerfilUno.js"></script>
							...
							<!-- Content -->
								<section class="8u 12u(mobile)">
									...
									<div class="12u 12u$(medium)"> <!-- Sec form -->
										...
										<!-- form start -->
										<form role="form" id="edit-datos" autocomplete="off" method="post" action="">
											<div class="row uniform 50%">	
												...
												<!-- Break -->
												<div class="3u"><span>Nombre: </span></div>
												<div class="-1u 6u$"><span><input type='text' name='user_name' class="form-class" placeholder='Nombre'/></span>
												</div>
												
												<!-- Break -->
												<div class="3u"><span>Apellido:</span></div>
												<div class="-1u 6u$"><span><input type='text' name='user_apellido' class="form-class" placeholder='Apellido'/></span></div>
