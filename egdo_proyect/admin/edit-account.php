...
<html>
	<head>
		...
		<script type="text/javascript" src="assets/js/functionAccount.js"></script>
		...
		<div id="page-wrapper">
			...
			<!-- Header Wrapper -->
				...
				<?php
					...
					$consulta= "SELECT email FROM usuario WHERE id_usuario='$id_usuario'";
							...
							<!-- Content -->
								<section class="8u 12u(mobile)">
									...
									<div class="12u 12u$(medium)"> <!-- Sec form -->
										...
										<!-- form start -->
										<form role="form" id="edit-mail" autocomplete="off" method="post" action="">
											...
											<div class="row uniform 50%">	
												...
												<div class="-1u 6u$"><span><input type='text' name='email' class="form-class" placeholder='usuario@usuario.com'/></span>
												</div>
