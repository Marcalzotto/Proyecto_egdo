...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body class="no-sidebar">
				...
				<div id="main-wrapper">
					...
					<!-- Wide Content -->
						<section id="content" class="container">
							...
							<h3>Moderar Comentarios Info Viaje</h3>
		...
		$consulta = ("SELECT id_comment,comentario,id_info_viaje,id_usuario,fecha,estado_moderar FROM comentario_infoviaje ORDER BY id_comment DESC");
		...
		?>
			...
			<td><?php echo $row['id_info_viaje']; ?></td>
			<td><?php echo $row['id_usuario']; ?></td>
			<td><?php echo $row['fecha']; ?></td>
			<td><?php echo $row['estado_moderar']; ?></td>
			<td>
				<a href="edit_comInfoViaje.php?comm=<?php echo $id_protegido=base64_encode($row['id_comment']);?>" class="edit-link" href="#" title="Editar">
