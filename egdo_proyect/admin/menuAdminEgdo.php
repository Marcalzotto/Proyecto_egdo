<!-- Nav -->
								<nav id="nav">
									<ul>
										...
										<li> 
											<span class="hint--bottom hint--always" data-hint="home">
										...
										<!-- Item search -->
										<li>
											<span class="hint--bottom hint--always" data-hint="Buscar">
											<a href="#" title="Buscar">
												<span class="fa-stack fa-3x">
												<i class="fa fa-circle fa-stack-2x"></i>
										...
										<!-- Item filter -->
										<li class="break" >
											<span class="hint--bottom hint--always" data-hint="Filtrar">
										...
										<!-- Item setting -->
										<li>
											<span class="hint--bottom hint--always" data-hint="Herramientas">
