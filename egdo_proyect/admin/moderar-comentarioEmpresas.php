...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body class="no-sidebar">
				...
				<div id="main-wrapper">
					...
					<!-- Wide Content -->
						<section id="content" class="container">
							...
							<h3>Moderar Comentarios Empresas</h3>
		...
		?>
			...
			<td>
				<a href="edit_comentarioEmpresa.php?ce=<?php echo $id_protegido=base64_encode($row['id_comentario']);?>" class="edit-link" href="#" title="Editar">
