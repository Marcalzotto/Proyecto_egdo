...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body class="no-sidebar">
		...
		$consulta = ("SELECT id_fiesta,nombre,telefono,foto_perfil,id_usuario_propuesta,calle,altura,estado_moderar
		...
		?>
			...
			<td><img class="mod-img-table" src="../images/lugares_fiesta/<?php echo $row['foto_perfil']; ?>" /></td>
