...
(function ( $ ) {
	...
	var tocalendar = function() {
		...
		for(var o = 0; o<ev.length;o++) {
			$(".specific-day-scheme").append('<div class="specific-day-scheme-event"><h1>'+ev[o]['name']+'</h1><p data-role="dur"><a class="colorbox" href="ajax.php?accion=edicion&idevento='+ev[o]['idevento']+'"><img src="../images/calendar_img/026.png"></a><a class="colorbox" href="ajax.php?accion=eliminar&idevento='+ev[o]['idevento']+'"><img src="../images/calendar_img/020.png"></a></p></div>');
		}
		}
	}
	...
	function calendarSetMonth(ele,offset) {
		...
		ele.find(".calendar-month-view p").text(monthArray[d.getMonth()][1]+' '+d.getFullYear());
			...
			for(var i=0;i<42;i++) {
				...
				//var cal_day = $('<div class="calendar-day"><div class="date-holder"><a class="colorbox" href="ajax.php?accion=insertar&dia='+d.getFullYear()+'-'+(d.getMonth()+1)+'-'+d.getDate()+'"><img src="../images/calendar_img/021.png"></a>'+d.getDate()+'</div></div>');
				var cal_day = $('<div class="calendar-day"><div class="date-holder"><a class="colorbox" href=""><img src="../images/calendar_img/021.png"></a>'+d.getDate()+'</div></div>');
