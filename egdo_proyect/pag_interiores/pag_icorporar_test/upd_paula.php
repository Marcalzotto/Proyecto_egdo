...
<section id="content" class="container">
							...
							$verificarAdmin = "select * from usuario where id_usuario = '$obtUsuario' and curso = '$obt_curso'";
							$verificar = $conexion->query($verificarAdmin) or die($conexion->error);
							if($verificar){
								echo "<form id='pasarimagenes' class='form-validation' enctype='multipart/form-data' method='post' action='upd-2.php'>
                                 <fieldset>
