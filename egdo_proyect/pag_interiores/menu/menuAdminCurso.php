...
<div id="logoE" class="logo">
			<a href="../pag_interiores/indexUsuarioAdminCurso.php"><img src="../favicon/favicon-96x96.png" alt=""></a>
</div>
	...
	<li class="circle"><a href="../pag_interiores/upd.php"><img src="../images/upd.png" alt="UPD"></a></li>
		...
		<li class="circle">
			<a href="#">
				...
				<ul>
					...
					<li><a href="../pag_interiores/fotoUpdAdmin.php">Fotos UPD<img src="../images/dropotron_icons/upd.png" alt="" style="float:right"></a></li>
					<li><a href="../pag_interiores/galeriaFiestaAdmin.php">Fotos Fiesta de Egresados<img src="../images/dropotron_icons/party.png" alt="" style="float:right"></a></li>
					<li><a href="../pag_interiores/fotoViajeEgresadosAdmin.php">Fotos Viaje de Egresados<img src="../images/dropotron_icons/viaje_egresados.png" alt="" style="float:right"></a></li>
					<li><a href="../pag_interiores/formSubirFotosAdmin.php">Subi tus fotos<img src="../images/dropotron_icons/upload.png" alt="subir fotos" style="float:right"></a></li>
				</ul>
		</li>
		...
		<li class="circle"><a href="#">
								...
								<ul>
									...
									<li><a class="notificacion" href="../pag_interiores/notificacionesAdmin.php">Notificaciones<?php
