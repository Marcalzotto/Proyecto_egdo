...
<div id="logoE" class="logo">
	<a href="../pag_interiores/index_usuarioComun.php">
	...
	<!-- UPD -->
		...
		<li class="circle">
			...
			<ul>
				<!-- Diseno -->
				<li>
					<a href="../pag_interiores/Tee-Designer-Master/index.php">Dise&ntilde;o
						<img src="../images/dropotron_icons/disenio_ropa.png" alt="" style="float:right">
					</a></li>
			<!--<li>
					<a href="../pag_interiores/votacion.php">Votaci&oacute;n
						<img src="../images/dropotron_icons/votacion.png" alt="" style="float:right">
					</a>
				</li>
				<li>
					<a href="../pag_interiores/empresas.php">Empresas
						<img src="../images/dropotron_icons/empresas.png" alt="" style="float:right">
					</a>
				</li>
				<li>
					<a href="../pag_interiores/subir_arch.php">Subi tus dise&ntilde;os
		...
		<li class="circle">
			...
			<ul>
				...
				<!-- Agenda -->
				<li>
					<a href="../pag_interiores/agenda.php">Agenda
