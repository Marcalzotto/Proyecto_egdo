									...
									<li class="circle"><a href="#"><img src="../images/upd.png" alt="UPD"></a></li>
										...
										<li class="circle"><a href="#">
																			...
																			<ul>
																				...
																				<li><a href="notificacionesAdmin.php">Notificaciones <div id="cant_notificaciones">3</div><img src="../images/dropotron_icons/alarm.png" alt="agenda" style="float:right"></a>
																				</li>
