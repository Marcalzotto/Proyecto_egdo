										...
										<li class="circle">
											<a href="#">
												...
												<ul>
													...
													<li><a href="votacion.php">Votacion<img src="../images/dropotron_icons/votacion.png" alt="" style="float:right"></a></li>
	...
	<div id="banner-wrapper">
					...
					<div id="empresaDetalles">
								...
								<div id="detalle">
									...
									<li><p>Nombre:</p> <p>Empresa 3</p></li>
								...
								<div id="calificacion">	
											...
											<ul class="l1">
													...
													<li><img src="../images/dropotron_icons/avatar.png" alt="">:&nbsp;92 en Total.</li>
											</ul>
											<ul class="l2">
													
													<li><span>&#9733;</span>5<div style="width: 15px; height: 20px; background:#9EBF59;">5</div></li>
													<li><span>&#9733;</span>4<div style="width: 15px; height: 20px; background:#ACD532;">2</div></li>
													<li><span>&#9733;</span>3<div style="width: 20px; height: 20px; background:#FED733;">10</div></li>
													<li><span>&#9733;</span>2<div style="width: 50px; height: 20px; background:#FEB133;">50</div></li>
													<li><span>&#9733;</span>1<div style="width: 25px; height: 20px; background:#FE8A59;">25</div></li>
											</ul>
								</div>
