		...
		<div id="banner-wrapper">
    			...
    			$fecha_apertura->add(new dateInterval('P6D'));
					...
					//echo "Fecha fin segunda instancia + 4 dias".$fecha_fin_segunda_instancia->format("Y-m-d H:i:s")."</br>";
						...
						if($fechaHoy >= $fecha_apertura && $fechaHoy <= $fecha_fin_segunda_instancia){
							...
							<?php
								...
								$resultSetTipo1 = $conexion->query($qry) or die($conexion->error);
									...
									if($resultSetTipo1){
												...
												while($reg = $resultSetTipo1->fetch_array(MYSQLI_ASSOC)){
													...
													echo "<ul class=primer_instancia>";
														...
														foreach($varRegistros as $unVar){
															...
															echo "<li><a href=Tee-Designer-master/tdesignAPI/".$unVar['path_img_doble']."rel='lightbox'><img src=Tee-Designer-master/tdesignAPI/".$unVar['path_frontal']."width='105' height='105' class='ropa' alt='buzo frente'></a><p>Subido por: ".$unVar['nombre']."</p><p>Calificacion: <span>".$unVar['cantidad_votos']."</span><img data-id=".$unVar['id_disenio']." data-tipo=".$unVar['codigo_tipo']." src='../images/dropotron_icons/like.png' alt='Like'></p></li>";
														}
										...
										$traerDiseniosMasVotados = "select * from disenio as d join usuario u on d.id_usuario_subio = u.id_usuario where d.codigo_tipo = 1 and u.id_curso = '$_SESSION[curso]' order by d.cantidad_votos desc limit 3";
													...
													if($consultaMasVotados){
														...
														if($cantidadDeRegistros > 0){
																...
																while($deAunGanador = $consultaMasVotados->fetch_array(MYSQLI_ASSOC)){
																	...
																	echo "<li><a href=Tee-Designer-master/tdesignAPI/".$unoMasVotado['path_img_doble']." rel='lightbox'><img src=Tee-Designer-master/tdesignAPI/".$unoMasVotado['path_frontal']."width='105' height='105' class='ropa' alt='buzo frente'></a><p>Subido por: ".$unoMasVotado['nombre']."</p><p>Calificacion: <span>".$unoMasVotado['votos_segunda_instancia']."</span><img data-id=".$unoMasVotado['id_disenio']."data-tipo=".$unoMasVotado['codigo_tipo']." src='../images/dropotron_icons/like.png' alt='Like'></p></li>";	
																	}
    										...
    										$qry = "select * from disenio as d join usuario as u on d.id_usuario_subio = u.id_usuario 
    												...
    												if($resultSet){
    													...
    													if($cant_regs == 0){
    														...
    														echo "<li><a href=Tee-Designer-master/tdesignAPI/".$unRegistro['path_img_doble']."rel='lightbox'><img src=Tee-Designer-master/tdesignAPI/".$unRegistro['path_frontal']." width='105' height='105' class='ropa' alt='remera frente'></a><p>Subido por: ".$unRegistro['nombre']."</p><p>Calificacion: <span>".$unRegistro['votos_segunda_instancia']."</span><img data-id=".$unRegistro['id_disenio']." 
    											...
    											$traerDiseniosMasVotados = "select * from disenio as d join usuario u on d.id_usuario_subio = u.id_usuario where d.codigo_tipo = 2 and u.id_curso = '$_SESSION[curso]' order by d.cantidad_votos desc limit 3";
													...
													$consultaMasVotados = $conexion->query($traerDiseniosMasVotados) or die($conexion->error);
															...
															echo "<li><a href=Tee-Designer-master/tdesignAPI/".$unoMasVotado['path_img_doble']."rel='lightbox'><img src=Tee-Designer-master/tdesignAPI/".$unoMasVotado['path_frontal']." width='105' height='105' class='ropa' alt='remera frente'></a><p>Subido por: ".$unoMasVotado['nombre']."</p><p>Calificacion: <span>".$unoMasVotado['votos_segunda_instancia']."</span><img data-id=".$unoMasVotado['id_disenio']." 
    													...
    													$buscarGanador = "select * from disenio as d join usuario u on d.id_usuario_subio = u.id_usuario where d.codigo_tipo = 2 and u.id_curso = '$_SESSION[curso]' order by d.votos_segunda_instancia desc limit 1";
																...
																echo "<li><a href=Tee-Designer-master/tdesignAPI/".$elGanador['path_img_doble']." rel='lightbox'><img src=Tee-Designer-master/tdesignAPI/".$elGanador['path_frontal']."width='105' height='105' class='ropa' alt='remera frente'></a><p>Subido por: ".$elGanador['nombre']."</p><p>Calificacion: <span>".$elGanador['votos_segunda_instancia']."</span><img data-id=".$elGanador['id_disenio']." 
																	data-tipo=".$elGanador['codigo_tipo']." src='../images/dropotron_icons/like.png' alt='Like'></p></li>";	
    									...
    									if($fechaHoy >= $fecha_apertura && $fechaHoy <= $fecha_fin_primer_instancia){
												...
												$qry = "select * from disenio as d join usuario as u on d.id_usuario_subio = u.id_usuario 
    												...
    												if($resultSetTipo2){
    													...
    													$traerDiseniosMasVotados = "select * from disenio as d join usuario u on d.id_usuario_subio = u.id_usuario where d.codigo_tipo = 3 and u.id_curso = '$_SESSION[curso]' order by d.cantidad_votos desc limit 3";
    												...
    												$buscarGanador = "select * from disenio as d join usuario u on d.id_usuario_subio = u.id_usuario where d.codigo_tipo = 3 and u.id_curso = '$_SESSION[curso]' order by d.votos_segunda_instancia desc limit 1";
																...
																if($traerGanador){
																	...
																	if($hayUnGanador > 0){
																		...
																		echo "<li><a href=Tee-Designer-master/tdesignAPI/".$elGanador['path_img_doble']." rel='lightbox'><img src=Tee-Designer-master/tdesignAPI/".$elGanador['path_frontal']."width='105' height='105' class='ropa' alt='bandera'></a><p>Subido por: ".$elGanador['nombre']."</p><p>Calificacion: <span>".$elGanador['votos_segunda_instancia']."</span><img data-id=".$elGanador['id_disenio']." 
																			data-tipo=".$elGanador['codigo_tipo']." src='../images/dropotron_icons/like.png' alt='Like'></p></li>";	
