 ...
 //include('calcular_nuevo_ancho.php');
		...
		echo "<div class=row>";
			...
			echo  "</div>";
				...
				echo '
							<!-- FACEBOOK -->								
								<div style="text-align: center;" data-href="http://www.egdo.com.ar/pag_interiores/fiesta-2.php"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fwww.egdo.com.ar%2Fpag_interiores%2Ffiesta-2.php&amp;src=sdkpreparse"><img src="../images/faceCompartir.png" ></a></div>						
							<!-- compartir facebook -->';
				echo "<div class=row>";
