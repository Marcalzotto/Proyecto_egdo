...
<?php 
	...
	$queryVerFecha = "select * from actividad_disenio where usuario_apertura = '$usuario' 
										and curso_pertenece_votacion = '$curso'";
			...
			<div id="banner-wrapper">
				...
				<div id="votacion">
						...
						<?php
								...
								echo '
								<!-- FACEBOOK -->								
									<div style="text-align: center;" data-href="http://www.egdo.com.ar/pag_interiores/votacionAdminCurso.php"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fwww.egdo.com.ar%2Fpag_interiores%2FvotacionAdminCurso.php&amp;src=sdkpreparse"><img src="../images/faceCompartir.png" ></a></div>						
								<!-- compartir facebook -->';
									}else{
  							...
  							<label for="tab3"><img src="../images/tab_icons/flag.png" alt="">Bandera</label>
    							...
    							?>
									...
									?>
										...
										if(isset($_GET["grabado"])){
											$grabado = $_GET["grabado"];
											
											switch ($grabado) {
													case 1:
													echo "<p class='aviso-pdf'>El pdf se reemplazo con exito</p>";
													break;

													case 2:
													echo "<p class='aviso-pdf'>Hubo un error al intentar reemplazar el pdf</p>";
													break;

													case 3:
													echo "<p class='aviso-pdf'>El pdf se guardo con exito</p>";
													break;

													case 4:
													echo "<p class='aviso-pdf'>hubo un error al intentar guardar el pdf</p>";
													break;
												
												default:
													echo "<p class='aviso-pdf'>hubo un error inesperado</p>";
													break;
											}
