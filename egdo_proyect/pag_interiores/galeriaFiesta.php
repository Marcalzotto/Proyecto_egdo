              ...
              if($ejecutarQuery){
                  ...
                  if($hayFotos > 0){
                      ...
                      echo "<section id='content' class='container'>";
						...
						echo '
							<!-- FACEBOOK -->								
								<div style="text-align: center;" data-href="http://www.egdo.com.ar/pag_interiores/galeriaFiesta.php"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fwww.egdo.com.ar%2Fpag_interiores%2FgaleriaFiesta.php&amp;src=sdkpreparse"><img src="../images/faceCompartir.png" ></a></div>						
							<!-- compartir facebook -->';
