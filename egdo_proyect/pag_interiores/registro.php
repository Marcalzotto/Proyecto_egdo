				...
				<div class="rows">
					...
					<form action="/" role="form">
						...
						<div class="form-wizard">
							...
							<div class="rows">
								...
								<div class="col-md-8 col-sm-7">
									...
									<fieldset class="input-block">
										...
										<input type="text" id="username" class="form-icon form-icon-user" placeholder="Nombre" required />
										<div class="tooltip">
											<p>
									...
									<fieldset class="input-block">
										...
										<input type="text" id="surname" class="form-icon form-icon-user" placeholder="Apellido" required />
										<div class="tooltip">
											<p>
												<b>Why do we need this info?</b>
												Lorem Ipsum is simply dummy text of the printing and
									...
									<fieldset class="input-block">
										...
										<input type="password" id="pass-confirm" placeholder="Password" required />
										<div class="tooltip">
											<p>
												<b>Why do we need this info?</b>
												Lorem Ipsum is simply dummy text of the printing and
									...
									<fieldset class="input-block">
										...
										<input type="text" id="email" class="form-icon form-icon-mail" placeholder="Email" required />
										<div class="tooltip">
											<p>
												<b>Why do we need this info?</b>
												Lorem Ipsum is simply dummy text of the printing and
							...
							<div class="next">
								<button class="button button-control" type="button" onclick="window.location.href='registro-icon1.php'"><span>Siguiente Paso <b> Datos Curso</b></span></button>
								<div class="button-divider"></div>
							</div>
