			...
			<div class="form-container">
				...
				<div id="tmm-form-wizard" class="containers substrate">
					...
					<form action="/" role="form">
									...
									<div class="rows">
										...
										<div class="col-md-12 col-sm-12">
											<fieldset class="input-block">
												...
												<input type="text" id="phone" class="form-icon form-icon-phone" placeholder="Number" required />
												<div class="tooltip">
													<p>
														<b>Why do we need this info?</b>
														Lorem Ipsum is simply dummy text of the printing and
						...
						<div class="prev">
							<button class="button button-control" type="button" onclick="window.location.href='registro.php'"><span>Paso Anterior <b>Tus Datos</b></span></button>
							<div class="button-divider"></div>
						</div>
						
						<div class="next">
							<button class="button button-control" type="button" onclick="window.location.href='registro-icon2.php'"><span>Paso Siguiente <b>Enviar Invitacion</b></span></button>
							<div class="button-divider"></div>
						</div>
