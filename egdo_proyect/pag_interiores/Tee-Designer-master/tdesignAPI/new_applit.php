	...
	<div class='design_api'>
		...
		<div id='options'>
			...
			<div class="color_pick">
				...
				<div class="color_radio_div" id="royal"></div>
			...
			<div class="">
				...
				<!--<table class="table">
					...
					<tr>
						<td><b>Total</b></td>
						<td>
						<input id="total" name="total" type="number" value="0" class="form-control total input-md" disabled min=1 max=99999 />
						</td>
					</tr>
								...
								<center>
									<table class="table">
										...
										<tr>
											...
											<td>
											<input id="total2" name="total" type="number" value="0" class="form-control total input-md" disabled min=1 max=99999 />
											</td>
										</tr>
