    ...
    <header role="banner">
      ...
      <!-- Main Wrapper -->
        <div id="main-wrapper">
          ...
          <!-- Wide Content -->
          <h2>Galeria Viaje de Egresados</h2>
           <?php
              require_once('conexion.php');

              $curso = $_SESSION['curso'];
              $buscarFotosGaleria = "select * from imagen where id_actividad = 4 and id_curso = '$curso'";
              ...
              if($ejecutarQuery){
                  ...
                  if($hayFotos > 0){
                      ...
                      echo "<section id='content' class='container'>";
						...
						echo '
							<!-- FACEBOOK -->								
								<div style="text-align: center;" data-href="http://www.egdo.com.ar/pag_interiores/fotoViajeEgresadosAdmin.php"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fwww.egdo.com.ar%2Fpag_interiores%2FfotoViajeEgresadosAdmin.php&amp;src=sdkpreparse"><img src="../images/faceCompartir.png" ></a></div>						
							<!-- compartir facebook -->';
