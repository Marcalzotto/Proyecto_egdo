...
$mysqli = new mysqli($rating_dbhost,$rating_dbuser,$rating_dbpass,$rating_dbname);
if($mysqli->connect_errno){
	die("Error de conexion con la base de datos:".$mysqli->connect_error);
}
